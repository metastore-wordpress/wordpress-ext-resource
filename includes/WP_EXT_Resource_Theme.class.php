...
/**
 * Class WP_EXT_Resource_Theme
 */
class WP_EXT_Resource_Theme extends WP_EXT_Resource {
 ...
 *
 * @return WP_EXT_Resource_Theme
 */
function WP_EXT_Resource_Theme() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Resource_Theme;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_Resource_Theme(), 'run' ] );
