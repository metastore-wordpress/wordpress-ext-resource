...
/**
 * Class WP_EXT_Resource_Post_Type
 * ------------------------------------------------------------------------------------------------------------------ */

class WP_EXT_Resource_Post_Type extends WP_EXT_Resource {
	...
	public function post_type() {
		$labels  = [
			'name'                  => _x( 'Resources', 'Resource General Name', 'wp-ext-' . $this->domain_ID ),
			'singular_name'         => _x( 'Resource', 'Resource Singular Name', 'wp-ext-' . $this->domain_ID ),
			'menu_name'             => __( 'Resources', 'wp-ext-' . $this->domain_ID ),
			'name_admin_bar'        => __( 'Resource', 'wp-ext-' . $this->domain_ID ),
		...
		$args    = [
			'label'               => __( 'Resource', 'wp-ext-' . $this->domain_ID ),
			'description'         => __( 'Resource Description', 'wp-ext-' . $this->domain_ID ),
			'labels'              => $labels,
 ...
 *
 * @return WP_EXT_Resource_Post_Type
 * ------------------------------------------------------------------------------------------------------------------ */

function WP_EXT_Resource_Post_Type() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Resource_Post_Type;
	}
...
add_action( 'plugins_loaded', [ WP_EXT_Resource_Post_Type(), 'run' ] );
