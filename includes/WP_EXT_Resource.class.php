...
class WP_EXT_Resource {
	...
	public function __construct() {
		// Settings.
		$this->pt_ID      = 'resource';
		$this->archive_ID = 'resources';
		$this->domain_ID  = 'resource';
		$this->cap_type   = [ 'pt_resource', 'pt_resources' ];
 ...
 *
 * @return WP_EXT_Resource
 */
function WP_EXT_Resource() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Resource;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_Resource(), 'run' ] );
